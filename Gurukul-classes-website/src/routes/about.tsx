...
const VALUES = [
  {
    Icon: Target,
    title: "Result Driven",
    text: "Every plan is reverse-engineered from the outcome students aspire to.",
  },
  {
    Icon: Heart,
    title: "Student First",
    text: "Care for individual progress over batch averages.",
  },
  {
    Icon: ShieldCheck,
    title: "Integrity",
    text: "Honest counselling, transparent fees, no false promises.",
  },
    ...
    <>
      ...
      <section className="relative z-10 bg-white py-16 md:py-24">
        <div className="container mx-auto px-4 grid lg:grid-cols-2 gap-12 items-center">
          <div className="relative">
            ...
            <img
              src={aboutTeaching}
              alt="Senior faculty teaching"
              className="relative rounded-2xl shadow-card object-cover w-full h-[480px]"
              loading="lazy"
            />
          ...
          <div>
            <SectionTitle
              eyebrow="Our Story"
              title="Built on trust. Powered by results."
              align="left"
            />
            ...
            <p className="mt-4 text-muted-foreground leading-relaxed">
              ...
              learning, regular assessment and conceptual understanding with accessible guidance for
              families across Kalyan and Bhiwandi.
            </p>
            <div className="mt-8 grid grid-cols-2 gap-4">
              <div className="rounded-2xl border border-border bg-white p-5 shadow-soft">
                ...
                <p className="mt-1 text-sm text-muted-foreground">
                  Mentor every student into the institution and career of their choice.
                </p>
              </div>
              <div className="rounded-2xl border border-border bg-white p-5 shadow-soft">
                ...
                <p className="mt-1 text-sm text-muted-foreground">
                  Be India's most trusted neighborhood institute for science excellence.
                </p>
              </div>
            </div>
          </div>
            ...
            {[
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <span className="mt-5 inline-flex text-sm font-bold text-[#2563EB]">
                    View profile
                  </span>
                </div>
              </Link>
      ...
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-4">
          <SectionTitle
            eyebrow="Faculty"
            title="Mentors who've seen it all"
            description="A team of senior IIT-JEE, NEET and MH-CET faculty with decades of result-oriented teaching experience."
          />
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {["Physics Dept.", "Chemistry Dept.", "Mathematics Dept.", "Biology Dept."].map(
              (d, i) => (
                <div
                  key={d}
                ...
                >
                  ...
                  <p className="mt-1 text-xs text-[#2563EB] font-semibold tracking-wider uppercase">
                    {15 + i * 3}+ Years Experience
                  </p>
                  <p className="mt-3 text-sm text-muted-foreground">
                    A senior team trained at India's top universities, focused on conceptual clarity
                    and exam strategy.
                  </p>
                </div>
              ),
        ...
        <div className="container relative z-10 mx-auto px-4 grid lg:grid-cols-[1.3fr_1fr] gap-10 items-center">
          <div>
            <h2 className="text-3xl md:text-5xl font-bold">
              Visit a centre. Meet our team. Decide for yourself.
            </h2>
            <p className="mt-4 text-white/80">
              Schedule a campus visit or a free counselling session at your nearest branch.
            </p>
          </div>
          <div className="flex flex-wrap gap-3 lg:justify-end">
            ...
            <Link
              ...
              className="inline-flex items-center gap-2 rounded-lg bg-white px-6 py-3 text-sm font-bold text-brand-ink hover:bg-[#EAF1FF] transition-colors"
            >
              View Programs
            </Link>
          </div>
