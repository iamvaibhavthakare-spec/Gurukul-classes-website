...
export const BRANCHES: Branch[] = [
  {
    ...
    area: "Kalyan (W)",
    address: "2nd Floor, Yadnyavalkya Bld, Sahajanand Chowk, Agra Road, Kalyan (W) 421301",
    phone: "+91 9833036464",
...
export const COURSE_BY_SLUG: Record<string, Course> = Object.fromEntries(
...
export const METHODOLOGY = [
  {
    ...
    text: "Map every student's strengths and gaps before the journey begins.",
  },
  {
    step: "02",
    title: "Concept Lectures",
    text: "Senior faculty deliver concept-first lectures with real-life examples.",
  },
  {
    step: "03",
    title: "Practice and Revision",
    text: "Daily Practice Problems lock in concepts and build problem-solving speed.",
  },
  {
    step: "04",
    title: "Periodic Testing",
    text: "Chapter, monthly, prelim and full-syllabus tests modelled on actual exams.",
  },
  {
    step: "05",
    title: "Doubt Solving Session",
    text: "Walk-in doubt solving and one-on-one mentoring throughout the year.",
  },
  {
    step: "06",
    title: "Performance Review",
    text: "Detailed analytics shared with students and parents for course-correction.",
  },
];
...
export const TESTIMONIALS = [
  {
    name: "Ananya Sharma",
    role: "NEET Aspirant, Kalyan",
    text: "The biology mentoring at Gurukul changed how I approach NCERT. Daily DPPs and weekly tests built my confidence.",
  },
  {
    name: "Rohit Patil",
    role: "IIT-JEE 2024, Bhiwandi",
    text: "The JEE faculty pushed me beyond textbook problems. Without their problem-solving sessions I wouldn't have cracked Advanced.",
  },
  {
    name: "Mrs. Deshpande",
    role: "Parent, Class XII",
    text: "Regular parent updates and a sincere mentor team — Gurukul felt like a true partner in my daughter's preparation.",
  },
  {
    name: "Saanvi Kulkarni",
    role: "MH-CET Topper",
    text: "The CET-pattern mock tests and speed drills made me exam-ready months in advance. Highly recommended.",
  },
  {
    name: "Aarav Joshi",
    role: "XI Science Student",
    text: "Best integrated programme in Kalyan. I never feel boards and Entrance are two different things anymore.",
  },
  {
    name: "Prisha Nair",
    role: "Class X Student",
    text: "Chapter tests and correction sessions helped me understand exactly where I was losing marks.",
  },
  {
    name: "Mr. Kulkarni",
    role: "Parent, IX Foundation",
    text: "The regular updates gave us confidence that our child was building habits, not just attending classes.",
  },
  {
    name: "Devansh Shah",
    role: "JEE Main Aspirant",
    text: "The faculty explained difficult physics problems step by step and made revision feel manageable.",
  },
  {
    name: "Ira More",
    role: "XII Science Student",
    text: "The test schedule kept me consistent through the year and helped me prepare for boards and CET together.",
  },
];
...
export const PRESS = [
  {
    ...
    excerpt:
      "More than 80% of our XII Science batch crossed the 95-percentile mark in MH-CET 2024.",
  },
  {
    date: "Jan 2025",
    title: "New Anjurphata centre inaugurated in Bhiwandi",
    excerpt:
      "Our fifth branch opens its doors with state-of-the-art classrooms and a dedicated test centre.",
  },
  {
    date: "Aug 2024",
    title: "Felicitation of NEET & JEE 2024 toppers",
    excerpt:
      "A celebratory evening honouring 120+ students who secured admissions in top medical and engineering colleges.",
  },
  {
    date: "Jun 2024",
    title: "Gurukul launches integrated Foundation programme",
    excerpt:
      "A redesigned VIII–X foundation track focused on concept building and early competitive exposure.",
  },
];
