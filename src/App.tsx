...
const ROUTES: Record<string, { title: string; Component: () => JSX.Element }> = {
  ...
  "/courses/ix-ssc-cbse": { title: "IX SSC / CBSE - Gurukul Science Classes", Component: CourseIxSscCbse },
  ...
  "/courses/viii-ssc-cbse": { title: "VIII SSC / CBSE - Gurukul Science Classes", Component: CourseViiiSscCbse },
  "/courses/x-ssc-cbse": { title: "X SSC / CBSE - Gurukul Science Classes", Component: CourseXSscCbse },
  "/courses/xi-science": { title: "XI Science - Gurukul Science Classes", Component: CourseXiScience },
  "/courses/xii-science": { title: "XII Science - Gurukul Science Classes", Component: CourseXiiScience },
};
...
export function App() {
  ...
  const route = useMemo(() => ROUTES[path], [path]);
