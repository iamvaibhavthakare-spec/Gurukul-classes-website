...
export function WhatsAppButton() {
  const href = `https://wa.me/${SITE.whatsapp}?text=${encodeURIComponent(WHATSAPP_FORMAL_MESSAGE)}`;
  return (
    <a
      href={href}
      target="_blank"
    ...
    >
      <svg aria-hidden="true" viewBox="0 0 16 16" className="h-6 w-6" fill="currentColor">
