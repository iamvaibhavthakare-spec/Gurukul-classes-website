        ...
        <div className="container mx-auto grid gap-12 px-4 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
          <div>
            ...
            <p className="text-lg leading-relaxed text-muted-foreground">
              Bhagyashree Vaibhav Thakare carries Gurukul's commitment to quality education and
              true guidance for students. Her work focuses on creating a complete learning
              environment where students develop confidence, discipline and academic potential.
            </p>
            <p className="mt-4 leading-relaxed text-muted-foreground">
              As Director, she supports Gurukul's interactive style of education: vibrant,
              creative, stimulating and challenging coaching that helps students excel in academics
